...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex border-2 border-border bg-muted p-1 text-muted-foreground', className)}
    {...props}
  />
));
